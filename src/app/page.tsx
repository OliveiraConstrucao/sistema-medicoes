    ...
    <div className="min-h-screen bg-slate-100 md:flex">
      <aside className="hidden md:fixed md:inset-y-0 md:flex md:w-64 md:flex-col md:bg-slate-950 md:text-white">
        ...
        <nav className="flex-1 space-y-2 p-4">
          <button className="flex w-full items-center gap-3 rounded-xl bg-slate-800 px-3 py-3 text-left font-medium">
            <span>📊</span>
            Painel
          </button>

          <button className="flex w-full items-center gap-3 rounded-xl px-3 py-3 text-left text-slate-300 hover:bg-slate-800">
            <span>📄</span>
            Medições
          </button>
      ...
      <main className="w-full p-3 md:ml-64 md:p-8">
        <div className="mb-5 rounded-2xl bg-white p-4 shadow md:hidden">
          ...
          <div className="mt-4 grid grid-cols-4 gap-2">
            <button className="rounded-xl bg-slate-900 p-2 text-xs text-white">
              📊<br />Painel
            </button>

            <button className="rounded-xl bg-slate-100 p-2 text-xs text-slate-700">
              📄<br />Medições
            </button>
